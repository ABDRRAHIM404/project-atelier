-- Notify active managers after a verified customer quotation refusal without exposing manager rows
select pg_advisory_xact_lock(hashtextextended('project-atelier:quotation-decline-notification-v1', 0));
