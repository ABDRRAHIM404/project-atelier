...
const steps = [
  [
    '01',
    'اختر نقطة البداية',
    'اختر تصميمًا من الكتالوج لتخصيصه، أو أرسل صورًا ومخططًا لتصميم أثاث خاص بك.',
  ],
  [
    '02',
    'حدد التفاصيل',
    'أدخل المقاسات والخامة واللون والكمية والملاحظات، ويمكنك ترك تصميم الكتالوج كما هو.',
  ],
  [
    '03',
    'أرسل الطلب للمراجعة',
    'يراجع المدير إمكانية التنفيذ، ويمكنه طلب معلومات إضافية قبل إعداد عرض السعر.',
  ],
  ['04', 'راجع عرض السعر', 'يظهر لك سعر التصنيع وتكلفة التوصيل والمدة المتوقعة قبل القبول.'],
  ['05', 'اقبل أو ارفض', 'يمكنك قبول العرض، رفضه مع السبب، أو إلغاء الطلب عندما تسمح حالته بذلك.'],
  ['06', 'ادفع بأمان', 'بعد تأكيد الاستلام تنتقل إلى صفحة مزود الدفع الآمنة عند تفعيل الخدمة.'],
  [
    '07',
    'تابع التصنيع',
    'تابع تأكيد الدفع وتجهيز الخامات والتصنيع وفحص الجودة والاستلام أو التوصيل.',
  ],
  [
    '08',
    'احتفظ بكل شيء منظمًا',
    'تجد الرسائل والإشعارات والطلبات الملغاة والمكتملة داخل مساحتك وسجلّك.',
  ],
] as const;
      ...
      <main id="main-content" tabIndex={-1}>
        <section className="page-hero section-shell" aria-labelledby="process-title">
          ...
          <div className="button-row">
            ...
            <Link className="button button--secondary" href="/custom-design">
              أرسل تصميمك الخاص
            </Link>
          </div>
        </section>
